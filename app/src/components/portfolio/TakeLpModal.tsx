...
export interface TakeLpPosition {
            ...
            <div>
              ...
              <p className="text-[11px] text-[#efe0f7]/35">
                ...
                <span className="tabular-nums text-[#efe0f7]/60">
                  {owedUi.toLocaleString("en-US", { maximumFractionDigits: 6 })}{" "}
                  LP
                </span>
              </p>
            </div>
        ...
        <div className="px-5 pb-5 pt-4 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            <div className="flex items-center justify-between gap-2 px-2">
              ...
              <button
                onClick={() => setAmount(owedUi.toFixed(6))}
                className="text-[11px] text-[#efe0f7]/35 hover:text-[#c698e5] transition-colors cursor-pointer tabular-nums"
              >
                Max:{" "}
                {owedUi.toLocaleString("en-US", { maximumFractionDigits: 6 })}{" "}
                LP
          ...
          <div className="flex gap-1.5">
            {[25, 50, 75, 100].map((p) => (
              <button
                key={p}
                onClick={() => setAmount(((owedUi * p) / 100).toFixed(6))}
